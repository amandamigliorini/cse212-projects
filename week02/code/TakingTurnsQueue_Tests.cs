...
public class TakingTurnsQueueTests
{
    ...
    //                  Method Enqueue on PersonQueue.cs: _queue.Insert(0, person); Corrected to _queue.Add(person);
    //                  Method GetNextPerson on TakingTurnsQueue.cs had problems on the logics, 
    //                  conditions needed to be corrected;               
    ...
    //                  Method Enqueue on PersonQueue.cs: _queue.Insert(0, person); Corrected to _queue.Add(person);
    //                  Method GetNextPerson on TakingTurnsQueue.cs had problems on the logics, 
    //                  conditions needed to be corrected. The infinite turns wasn't there.
